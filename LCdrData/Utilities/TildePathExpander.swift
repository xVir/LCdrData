...
struct AccountHomeDirectoryProvider: HomeDirectoryProviding {
...
struct TildePathExpander: Sendable {

    private let home: HomeDirectoryProviding

    init(home: HomeDirectoryProviding = AccountHomeDirectoryProvider()) {
        self.home = home
    }
