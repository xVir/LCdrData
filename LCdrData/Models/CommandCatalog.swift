...
enum CommandCatalog {
    ...
    static func binding(for command: Command) -> (key: KeyEquivalent, modifiers: EventModifiers)? {
        switch command {
    ...
    static func shortcut(for command: Command) -> KeyboardShortcut? {
    ...
    static func keyEquivalent(for command: Command) -> KeyEquivalent? {
